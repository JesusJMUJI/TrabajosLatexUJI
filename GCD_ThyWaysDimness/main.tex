...
\usepackage[spanish,es-noshorthands]{babel} % Idioma del documento
...
\titleformat{\section}[hang]{\ttfamily\itshape\Large\bfseries\raggedright}{\thesection}{2pc}{}
...
% For subsections
\titleformat{\subsection}[hang]{\large\bfseries}{\thesubsection}{1em}{}\titlespacing*{\subsection}{2em}{*1}{*1}

% For subsubsections
\titleformat{\subsubsection}[hang]{\normalsize\bfseries}{\thesubsubsection}{1em}{}\titlespacing*{\subsubsection}{4em}{*1}{*1}
