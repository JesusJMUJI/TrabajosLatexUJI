...
\newcommand{\gunpowder}{\SpaceGroteskText{Gunpowder}\xspace}
\newcommand{\humanity}{\SpaceGroteskText{Humanity}\xspace}
\newcommand{\hunters}{\SpaceGroteskText{Hunters}\xspace}
\newcommand{\hunter}{\SpaceGroteskText{Hunter}\xspace}
\newcommand{\TWD}{ \textbf{TWD}\xspace}

\newcommand{\SpaceGroteskText}[1]{{\SpaceGrotesk #1}}

% For subsections
\titleformat{\subsection}[hang]
{\large\bfseries}
{\thesubsection}{1em}{\SpaceGroteskText}
\titlespacing*{\subsection}{2em}{*1}{*1}

% For subsubsections
\titleformat{\subsubsection}[hang]
{\normalsize\bfseries}
{\thesubsubsection}{1em}{\SpaceGroteskText}
